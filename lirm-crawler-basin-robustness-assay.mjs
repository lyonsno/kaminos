...
const defaults = {
  repoRoot,
  manifestPath: resolve(repoRoot, 'artifacts/lirm-crawler-basin-robustness-assay-v0/manifest.json'),
  outDir: resolve(repoRoot, 'artifacts/lirm-crawler-basin-robustness-assay-v0'),
};
