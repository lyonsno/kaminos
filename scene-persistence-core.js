...
export function isReloadableSceneObjectRecord(record) {
  ...
  return source.startsWith('/api/') || source.startsWith('http://') || source.startsWith('https://') || source.startsWith('demos/') || source.startsWith('artifacts/') || source.startsWith('assets/');
}
