...
import { writeLirmSpeciationArmatureImplicitBodyWitness } from './lirm-speciation-armature-core.js';
...
const outDir = args.get('--out-dir') || args.get('--out') || 'artifacts/lirm-speciation-armature-implicit-bodies-v0';
