...
try {
 ...
 r.correctionAfter=await page.evaluate(()=>window.kaminosSetSplatCorrectionDraftTransform({}));assert.deepEqual(r.correctionAfter.sceneTransform,r.correctionBefore.sceneTransform);assert.deepEqual(r.correctionAfter.draftCorrection,r.correctionBefore.draftCorrection);assert.deepEqual(r.correctionAfter.savedCorrection,r.correctionBefore.savedCorrection);assert.deepEqual(r.correctionAfter.cropTargetTransform,r.correctionBefore.cropTargetTransform);
