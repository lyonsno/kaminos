...
const WEBGPU_INFERENCE_KIT_VERSION = '0.1.52';
...
function createProductRouteWorkers() {
  ...
  return {
    ...
    marchingTetWorker: new Worker(new URL(/* @vite-ignore */ ""+new URL('assets/marching_tet_worker-DgRctJbx.js', import.meta.url).href+"", import.meta.url), { type: 'module', name: 'sf3d-marching-tet' }),
