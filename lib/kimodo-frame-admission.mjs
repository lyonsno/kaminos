...
export function verifyFrameAdmission(run,expectedMode,pageTimeOrigin){
  ...
  const foregroundQueueFence=expectedMode==='frame-admission';
  return {mode:expectedMode,passes:count,status:'verified',foregroundQueueFence,
    authority:foregroundQueueFence?'page-clock-current-duty-queue-prefix-and-fresh-dual-counter':'page-clock-pass-and-duty-timing'};
}
