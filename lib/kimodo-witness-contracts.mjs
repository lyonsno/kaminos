...
export function verifyIdentity({expected,effective,resources,weightsHash,url}) {
  ...
  for(const resource of resources)assert.equal(resource.sha256,resource.expectedSha256,`wrong served content: ${resource.path}`);
