...
assert.match(webgpuCoreSource, /KAMINOS_FINGER_FLUID_COLOR_MODES\s*=\s*Object\.freeze\(\['phase', 'particle_id', 'speed', 'density', 'surface', 'neighbor_retention'\]\)/, 'renderer diagnostic modes are explicit and enumerable');
...
assert.deepEqual(webgpuMod.KAMINOS_FINGER_FLUID_COLOR_MODES, ['phase', 'particle_id', 'speed', 'density', 'surface', 'neighbor_retention']);
