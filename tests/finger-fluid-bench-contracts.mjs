...
assert.match(webgpuCoreSource, /restViscosityBlend = clamp\(params\.forces\.z \+ supportRestWeight \* 0\.16, 0\.0, 0\.24\)/, 'neighbor relaxation deepens only for supported rest');
...
assert.match(webgpuCoreSource, /cohesionActivity = 1\.0 - restStates\[index\]\.z \* 0\.72/, 'normalized cohesion cannot keep pumping the supported basin at full strength');
