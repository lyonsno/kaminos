...
assert.match(index, /from '\.\/motion-core\.js\?v=source-orientation-remap-20260627'/, 'motion route cache-busts motion-core after adding source orientation exports');
