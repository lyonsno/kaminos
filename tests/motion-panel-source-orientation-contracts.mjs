...
assert.match(index, /from '\.\/motion-core\.js\?v=source-orientation-remap-20260627-generated-motion-cliplets-20260627-cliplet-playback-20260627'/, 'motion route preserves the source-orientation cache-bust marker while adding the cliplet module markers');
