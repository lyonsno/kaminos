...
const source=process.argv[2]
  ? execFileSync('git',['show',`${process.argv[2]}:index.html`],{encoding:'utf8',maxBuffer:Infinity})
...
const render=new Function('performance','updateAnnularBurnerFrame','fireLightFieldPass','renderPipeline','fpsEl',
  `let fpsFrames=0,fpsLast=0,sceneFrameCount=0; const selectionFeedback=null,currentMesh=null,localLiquidHost=null; return function(){${body}};`)(
