...
assert.match(source, /\['full-pass', 'fence-light', 'single-layer', 'single-layer-serial'\]\.includes\(values\.schedule\)/, 'the native witness accepts only declared reference schedules and the opt-in serial arm');
