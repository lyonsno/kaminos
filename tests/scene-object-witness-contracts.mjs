...
assert.match(witness, /world-cartridge-continuity/, 'witness supports an authored world-cartridge continuity scenario');
...
assert.match(witness, /\/api\/runtime-config/, 'witness obtains source checkout identity from the server runtime contract');
assert.match(witness, /runtimeConfig\.source\.repoRoot/, 'witness compares expected source against explicit runtime repo identity instead of persistent scene storage');
...
assert.match(witness, /world cartridge route omitted its required making context/, 'world-cartridge witness fails when the independently requested route lacks making context');
assert.match(witness, /saved cartridge scene did not preserve the authored cast context/, 'world-cartridge witness proves the saved scene preserves cartridge, crucible, and cast identity');
assert.match(witness, /reopened cartridge scene did not restore the authored transform and context/, 'world-cartridge witness proves transform and making context survive browser reopen');
assert.match(witness, /receipt-authenticated-sf3d-output/, 'world-cartridge witness grants SF3D output authority only after receipt and byte-hash validation');
assert.match(witness, /provenance mismatch negative unexpectedly received SF3D authority/, 'world-cartridge witness proves a different valid GLB cannot inherit the expected SF3D authority');
assert.match(witness, /multi-context reopen changed persistent scene cartridge authority/, 'world-cartridge witness proves object registration and selection cannot replace scene meaning');
assert.match(witness, /failed restore contaminated persistent cartridge authority/, 'world-cartridge witness proves failed source restore cannot leak its cartridge meaning');
