...
assert.match(witness, /groom-neutral-observation/, 'witness supports label-free membership-neutral groom observation capture');
assert.match(witness, /capturePngClipScreenshot/, 'groom observation witness captures the renderer viewport instead of surrounding UI labels');
assert.match(witness, /membershipColorsVisible:\s*false/, 'groom observation witness records that membership colors are absent');
assert.match(witness, /gizmoVisible:\s*false/, 'groom observation witness records that transform gizmos are absent');
