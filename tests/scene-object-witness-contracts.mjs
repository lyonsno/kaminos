...
assert.match(witness, /F left the corrected splat authored pivot outside the viewport/, 'corrected splat witness fails if F leaves the authored pivot offscreen');
