...
assert.match(witness, /preview-bench-terrain-sample-contract/, 'witness supports a Preview Bench raw terrain sample packet scenario');
assert.match(witness, /kaminos\.preview-bench\.terrain-sample-witness\.v0/, 'Preview Bench terrain sample witness declares its report schema');
...
assert.match(witness, /terrainSampleState/, 'Preview Bench terrain sample witness records machine-readable state rather than sidebar text alone');
...
assert.match(witness, /embeddedTerrainSamplePacket/, 'Preview Bench terrain sample witness proves embedded terrainSamplePacket extraction');
...
assert.match(witness, /Page\.captureScreenshot[\s\S]*previewBenchTerrainSample/, 'Preview Bench terrain sample witness captures a browser screenshot artifact');
...
assert.match(witness, /expectedSourceAuthority/, 'Preview Bench smoke-offer witness compares UI authority against the mounted producer offer instead of one fixture');
assert.match(witness, /expectedFreshnessStatus/, 'Preview Bench smoke-offer witness accepts the mounted producer freshness status, including stale evidence when visibly surfaced');
...
assert.match(witness, /terrainSampleTransport/, 'Preview Bench terrain sample witness records effective transport encoding');
assert.match(witness, /terrainSampleFetchUrl/, 'Preview Bench terrain sample witness records source-owned fetch URL');
assert.match(witness, /terrainSampleChecksum/, 'Preview Bench terrain sample witness records sample checksum');
