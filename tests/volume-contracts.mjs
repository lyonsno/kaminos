...
assert.match(applyTallPlumeOperatorPresetFn, /routedVolumeActivityPressureMaxTier\s*=\s*normalizeVolumeActivityPressureMaxTier\(preset\.activityPressureMaxTier/, 'Tall-plume presets apply route-owned Activity pressure max-tier state');
assert.match(applyTallPlumeOperatorPresetFn, /routedVolumeActivityPressureDispatchStrategy\s*=\s*normalizeVolumeActivityPressureDispatchStrategy\(preset\.activityPressureDispatchStrategy/, 'Tall-plume presets apply route-owned Activity pressure dispatch state');
