...
assert.doesNotMatch(bakedOrFlameLearnedBranch[1], /liveBoundarySupportAt/, 'Baked/flame-learned sidecar mode must not pay the live seven-tap boundary support path per ray step');
