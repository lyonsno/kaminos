...
assert.match(core, /uniforms\.set\(previousViewProj\.elements,\s*316\)/, 'previous view-projection matrix shifts after Bite-stack, flow, palette, topology-shell lab, boundary-fire, and scalar activity receiver uniforms');
