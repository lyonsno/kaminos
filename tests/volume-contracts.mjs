...
assert.doesNotMatch(brickWallContextSource, /backwashMaterial|contact-wash|AdditiveBlending/, 'brick-wall scene context must not keep a hidden CPU/Three contact-wash plane around');
