...
assert.match(witness, /else if \(!expectsReceiverSupportEvidence && !expectsReceiverLightIsolateEvidence && \([\s\S]*fireFuelOverlapRatio <= 0\.01[\s\S]*\)\) \{/, 'receiver-support and receiver-light isolate evidence routes do not require the legacy tall-plume fire/fuel overlap beauty threshold');
