...
assert.match(index, /volume-core\.js\?v=tall-flame-cutoff-speed-decoupled-0624/, 'volume prototype import carries a cache key when tall-plume flame cutoff semantics change');
