...
assert.match(core, /BOUNDARY_SIDECAR_BAKE_AUTHORITY\s*=\s*'band-limited-support-coverage-ridge-thickness-v0'/, 'Boundary sidecar bake names sample-efficient structure authority');
...
assert.match(core, /uniforms\.set\(previousViewProj\.elements,\s*320\)/, 'previous view-projection matrix shifts after Bite-stack, flow, palette, topology-shell lab, boundary-fire, boundary sidecar, and scalar activity receiver uniforms');
