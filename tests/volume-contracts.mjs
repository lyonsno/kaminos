...
assert.match(index, /volume-core\.js\?v=pyro-carrier-color-0702/, 'volume prototype import carries a cache key when Pyro carrier color shaping lands');
...
assert.match(core, /uniforms\[204\]\s*=\s*fireTongueGain/, 'CPU uploads fire tongue gain to the WGSL uniform block');
assert.match(core, /uniforms\[205\]\s*=\s*fireTongueShell/, 'CPU uploads fire tongue shell bias to the WGSL uniform block');
assert.match(core, /uniforms\[206\]\s*=\s*fireTongueWidth/, 'CPU uploads fire tongue width to the WGSL uniform block');
assert.match(core, /uniforms\[207\]\s*=\s*fireTongueRib/, 'CPU uploads fire tongue rib contrast to the WGSL uniform block');
assert.match(core, /uniforms\[208\]\s*=\s*fireTongueRelief/, 'CPU uploads fire tongue interior relief to the WGSL uniform block');
assert.match(core, /uniforms\[209\]\s*=\s*fireTongueTaper/, 'CPU uploads fire tongue tip taper to the WGSL uniform block');
