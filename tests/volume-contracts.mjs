...
assert.match(core, /uniforms\.set\(previousViewProj\.elements,\s*344\)/, 'previous view-projection matrix shifts after Bite-stack, flow, palette, topology-shell lab, boundary-fire, boundary sidecar reconstruction, sidecar display, selective live render controls, scalar activity receiver, flow reconstruction, shared presentation, and Boundary Fire palette uniforms');
