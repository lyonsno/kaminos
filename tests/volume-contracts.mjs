...
assert.match(index, /volume-core\.js\?v=smoke-only-frozen-diagnostic-0621/, 'volume prototype import carries a cache key when canonical diagnostic controls change');
