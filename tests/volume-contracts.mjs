...
assert.match(index, /id="volume-fire-tongue-gain"/, 'Volume tab exposes tall-plume tongue gain as an operator-tunable control');
assert.match(index, /id="volume-fire-tongue-shell"/, 'Volume tab exposes tall-plume tongue shell bias as an operator-tunable control');
assert.match(index, /id="volume-fire-tongue-width"/, 'Volume tab exposes tall-plume tongue width as an operator-tunable control');
assert.match(index, /id="volume-fire-tongue-rib"/, 'Volume tab exposes tall-plume tongue rib contrast as an operator-tunable control');
assert.match(index, /id="volume-fire-tongue-relief"/, 'Volume tab exposes tall-plume tongue interior relief as an operator-tunable control');
assert.match(index, /id="volume-fire-tongue-taper"/, 'Volume tab exposes tall-plume tongue tip taper as an operator-tunable control');
...
assert.match(index, /volume_fire_tongue_gain/, 'URL route can override fire tongue gain');
assert.match(index, /volume_fire_tongue_shell/, 'URL route can override fire tongue shell bias');
assert.match(index, /volume_fire_tongue_width/, 'URL route can override fire tongue width');
assert.match(index, /volume_fire_tongue_rib/, 'URL route can override fire tongue rib contrast');
assert.match(index, /volume_fire_tongue_relief/, 'URL route can override fire tongue interior relief');
assert.match(index, /volume_fire_tongue_taper/, 'URL route can override fire tongue tip taper');
...
assert.match(core, /fire_tongue_controls:\s*vec4<f32>/, 'WGSL exposes fire tongue gain/shell/width/rib controls');
assert.match(core, /fire_tongue_controls2:\s*vec4<f32>/, 'WGSL exposes fire tongue relief/taper controls');
...
assert.match(core, /fireTongueControls:\s*\{/, 'debug state exposes effective fire tongue controls');
assert.match(core, /fireTongueReadbackControls:\s*\{/, 'sim readback reports the effective fire tongue controls used by tongue evidence');
assert.match(core, /uniforms\[276\]\s*=\s*fireTongueGain/, 'CPU uploads fire tongue gain to the composed WGSL uniform block');
assert.match(core, /uniforms\[277\]\s*=\s*fireTongueShell/, 'CPU uploads fire tongue shell bias to the composed WGSL uniform block');
assert.match(core, /uniforms\[278\]\s*=\s*fireTongueWidth/, 'CPU uploads fire tongue width to the composed WGSL uniform block');
assert.match(core, /uniforms\[279\]\s*=\s*fireTongueRib/, 'CPU uploads fire tongue rib contrast to the composed WGSL uniform block');
assert.match(core, /uniforms\[280\]\s*=\s*fireTongueRelief/, 'CPU uploads fire tongue interior relief to the composed WGSL uniform block');
assert.match(core, /uniforms\[281\]\s*=\s*fireTongueTaper/, 'CPU uploads fire tongue tip taper to the composed WGSL uniform block');
