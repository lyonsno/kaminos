...
assert.match(index, /volume-core\.js\?v=tall-sim-cost-ledger-0624/, 'volume prototype import carries a cache key when tall-plume sim-cost/cadence semantics change');
