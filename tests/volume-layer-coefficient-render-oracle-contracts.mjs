...
assert.match(source, /kaminos\.volume\.layer-coefficient-prediction-overlay\.v0/, 'oracle pins the immutable learned coefficient overlay schema');
assert.match(source, /learned-post-admission-coefficient-prediction-v0/, 'oracle pins learned coefficient authority');
