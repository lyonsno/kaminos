...
assert.match(index, /<option value="128">128×256×128<\/option>\s*<option value="136">136×272×136<\/option>\s*<option value="140">140×280×140<\/option>/, 'the cockpit exposes the coherent vertically expanded grid range');
