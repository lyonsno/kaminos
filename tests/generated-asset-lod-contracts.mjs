...
assert.equal(manifest.schema, 'kaminos.generated-asset-lod.v0', 'manifest names the LOD contract');
...
assert.equal(assay.schema, 'kaminos.generated-asset-assay.v0', 'assay names its schema');
