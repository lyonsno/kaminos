...
assert.equal(typeof witnessContracts.snapshotEmissiveFieldFrame, 'function', 'readback metadata must be snapshotted before mapping');
...
const field = {
  ...
  physicalColor: { effective: 'emissive-transport-v2' },
};
const expected = { simStepCount: 7, effectiveRoute: field.effectiveRoute, physicalColor: field.physicalColor };
const files = {
...
const liveState = { simStepCount: 7, effectiveRoute: field.effectiveRoute, backend: 'WebGPU:apple', physicalColor: { effective: 'emissive-transport-v2', material: { ambientRadiance: 0 } } };
const snapshot = witnessContracts.snapshotEmissiveFieldFrame(0, liveState);
liveState.simStepCount = 8; liveState.physicalColor.material.ambientRadiance = 1;
