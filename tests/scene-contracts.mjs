...
assert.match(index, /id="forge-host-chamber-disposition"/, 'Forge Host smoke chamber exposes an operator disposition selector');
assert.match(index, /id="forge-host-chamber-note"/, 'Forge Host smoke chamber exposes an operator note field');
assert.match(index, /data-forge-chamber-affordance="screenshot"/, 'Forge Host smoke chamber exposes a screenshot capture affordance');
assert.match(index, /id="forge-host-chamber-return-line"/, 'Forge Host smoke chamber exposes a copyable source-thread return line');
