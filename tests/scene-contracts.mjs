...
assert.match(index, /pipelineDockState\.selectedGraphNodeId = outputNode\?\.id/, 'Graph execution should move selection to the appended generated-output node after a route produces a loadable artifact');
