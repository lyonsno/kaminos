...
assert.match(witness, /frame-000\.candidates\.f32/, 'witness materializes exact candidate float rows');
assert.match(witness, /frame-000\.raymarch\.png/, 'witness materializes the native raymarch target');
