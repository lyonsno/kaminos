...
const rows = [
  {
    id: 'cfg-0p25', strength: 0.25, generationJobId: '05501f23a0af',
    outputDir: '/Users/noahlyons/.local/state/gpu-greenroom/outputs/kaminos-lirm-multisource-sparse-guidance-20260715/source-0032/cfg-0p25',
    witnessJobIds: ['296d4dcc5600', 'aebcd1752ae5', '24b738cb924b', '80f4c2520dbd'],
  },
  {
    id: 'cfg-0p50', strength: 0.5, generationJobId: '5b3455019187',
    outputDir: '/Users/noahlyons/.local/state/gpu-greenroom/outputs/kaminos-lirm-multisource-sparse-guidance-20260715/source-0032/cfg-0p5',
    witnessJobIds: ['19158857b004', '5e8e838b0c2e', '8eee0755066d', 'e19cb76112bb'],
  },
  {
    id: 'cfg-0p75', strength: 0.75, generationJobId: 'cfaa31ef8666',
    outputDir: '/Users/noahlyons/.local/state/gpu-greenroom/outputs/kaminos-lirm-0032-sparse-recovery-20260715/cfg-0p75',
    witnessJobIds: ['59f1ac9faf05', '942f0c5c49fc', '29842128e876', '7b6bf0da113b'],
  },
  {
...
const sheetPath = join(artifactRoot, '0032-sparse-recovery-contact-sheet.png');
...
try {
  ...
  assertUsefulPngEvidence(sheetVisualEvidence, { minWidth: 2048, minHeight: 2224 }, '0032 recovery contact sheet');
...
const receipts = {
  schema: 'kaminos.lirm-trellis-0032-sparse-recovery-route-receipts.v1',
  allDoneExitZero: true, generationJobs, witnessJobs,
};
...
const sheet = {
  ...
  layout: 'four sparse CFG rows x left/front/right/rear views',
};
const experiment = {
  schema: 'kaminos.lirm-trellis-0032-sparse-recovery.v1',
