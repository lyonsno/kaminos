#!/usr/bin/env python3
"""Submit the frozen revision-050 Trellis selection idempotently."""
...
def main() -> None:
    ...
    results = json.loads(RESULTS.read_text())["cells"]
    submissions = json.loads(SUBMISSIONS.read_text()) if SUBMISSIONS.exists() else {
        "schema": "kaminos.cat-carrier-revision-050-camera-authority.trellis-submissions.v0",
