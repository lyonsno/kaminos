...
Question: Can the exact promoted Flamebowl actor activate, advance, render, expose
truthful carrier and GPU-stage timing, and release cleanly inside Wake's SHARP
...
The image is visibly coupled but oversized and overexposed, so it is not a
beauty-selection receipt.

Route:

- repo/worktree: `/private/tmp/kaminos-handy-wake-sharp-fireactor-0724`
- branch/base: `cc/handy-wake-sharp-fireactor-0724` from
  `a7611af557428123404dec9506501357a86ecad7`
- capture state: review candidate worktree, byte-identical implementation to be
