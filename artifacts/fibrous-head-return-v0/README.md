# Fibrous Head Return v0

This artifact binds one operator-authored skull, one inspected FLUX completion,
one exact TRELLIS request, and the observation products required before a
regional KEEP/HYBRID/REPLACE triage can begin.

It is deliberately a preflight, not a classifier. `cast_ready_for_triage` means
that the exact route and a complete source-camera textured/clay/normal/depth/
silhouette set are digest-bound. It never means the science or visual result is
