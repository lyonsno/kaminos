...
const BASE_TALL_PLUME_PARAMS = Object.freeze({
  ...
  volume_render_scale: 0.6,
  volume_steps: 140,
  volume_adaptive_rays: 0.4,
...
const PHASE_VOLUME_PROFILES = Object.freeze({
  burn: Object.freeze({
    ...
    volume_interface_shred: 5.0,
    volume_fire_licks: 3.9,
    volume_input_radius: 0.14,
    volume_flow_rate: 0.45,
    volume_reaction_fuel: 1.0,
    volume_absorption: 0.45,
  }),
