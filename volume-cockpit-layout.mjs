...
const ORGANIZED_GROUPS = [
  ...
  ['simulation', 'Simulation dynamics', /^volume-(resolution|speed|curl|projection|pressure-.+|canonical-.+|artistic-swirl|phased-sway|pyro-detail|advection-scheme|confinement|common-gas-transport)$/],
