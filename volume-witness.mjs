...
const TALL_PLUME_OPERATOR_PRESETS = {
  ...
  hostile_multiflame_pressure_force_0711: {
    label: 'hostile multiflame pressure force 0711',
    sourceCaptureIdentity: 'kaminos-volume-basin-emergency-live-dom-debug-capture-v1',
    sourceCaptureHash: '3518d1ef',
    sourceCapturedAt: '2026-07-11T11:44:47.198Z',
    volumeScene: 'tall_plume',
    density: 2.6,
    fire: 0,
    radiance: 0,
    ...
    reactionBoundaryGradient: 0.1,
    reactionBoundarySupportThermal: 0.94,
    reactionBoundarySupportReaction: 2,
    reactionBoundarySupportFront: 2,
    reactionBoundarySupportInterface: 2,
    reactionBoundaryCut: 0,
    reactionBoundarySoftness: 0.055,
    reactionBoundaryCoreReject: 0,
    reactionBoundaryTopology: 2.5,
    reactionBoundaryCurl: 1.18,
    reactionBoundaryDivergence: 1,
    reactionBoundaryContrast: 0.35,
    reactionBoundaryGamma: 1.15,
    reactionBoundaryOpacity: 3,
    reactionBoundaryFireRidge: 1.08,
    reactionBoundaryFireRidgeCut: 0,
    reactionBoundaryFireTip: 0.82,
    reactionBoundaryFireErosion: 0.1,
    reactionBoundaryFireCleanBlue: 0.24,
    reactionBoundaryFireSoot: 0.88,
    reactionBoundaryFireYellow: 0.1,
    reactionBoundaryFireWarmth: 0.2,
    reactionBoundaryFireLuma: 5,
    boundarySidecarBlur: 0,
    boundarySidecarWidth: 0,
...
async function main() {
  ...
  try {
    ...
    const report = {
      ...
      smokeDomainStrategy: sample.smokeDomainStrategy,
      smokeDomainNearGrid: sample.smokeDomainNearGrid,
      smokeDomainFarGrid: sample.smokeDomainFarGrid,
      smokeDomainHandoffPolicy: sample.smokeDomainHandoffPolicy,
      smokeDomainHandoffStatus: sample.smokeDomainHandoffStatus,
      smokeDomainProofBoundary: sample.smokeDomainProofBoundary,
      smokeDomainTransferEncoded: sample.smokeDomainTransferEncoded,
      smokeDomainTransferFrameCount: sample.smokeDomainTransferFrameCount,
      smokeDomainTransferActiveCells: sample.smokeDomainTransferActiveCells,
      smokeDomainFarInputActiveCells: sample.smokeDomainFarInputActiveCells,
      ...
      smokeDomainTransferLastReadbackFrame: sample.smokeDomainTransferLastReadbackFrame,
      smokeDomainTransferBufferBytes: sample.smokeDomainTransferBufferBytes,
      smokeDomainFarStateBufferBytes: sample.smokeDomainFarStateBufferBytes,
      smokeDomainFarSolverStatus: sample.smokeDomainFarSolverStatus,
      smokeDomainInspectMode: sample.smokeDomainInspectMode,
      smokeDomainInspectIdentity: sample.smokeDomainInspectIdentity,
