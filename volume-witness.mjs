...
async function main() {
  ...
  try {
      ...
      const nativeFrameEval = await wsRequest(ws, 'Runtime.evaluate', {
        expression: `(async () => {
          ...
          return {
            ...
            hybridSmokeFrontOpacityCeiling: sample.hybridSmokeFrontOpacityCeiling,
    ...
    const report = {
      ...
      hybridSmokeFrontOpacityCeiling: sample.hybridSmokeFrontOpacityCeiling ?? state.hybridSmokeFrontOpacityCeiling,
