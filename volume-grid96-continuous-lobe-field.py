...
:root{{--bg:#101214;--line:#363c41;--text:#f3f4f5;--muted:#aeb4b9;--accent:#ffd33d}}*{{box-sizing:border-box}}body{{margin:0;background:var(--bg);color:var(--text);font:14px/1.35 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:0}}header{{display:flex;gap:12px;align-items:center;flex-wrap:wrap;padding:10px 14px;background:#171a1c;border-bottom:1px solid var(--line)}}h1{{font-size:15px;margin:0}}label{{display:flex;gap:6px;align-items:center;color:var(--muted)}}main{{display:grid;grid-template-columns:minmax(0,1fr) 310px;gap:14px;padding:14px}}.stage{{width:min(100%,calc(100vh - 110px));aspect-ratio:1;margin:auto;background:#050607;border:1px solid var(--line)}}.stage img{{display:block;width:100%;height:100%;image-rendering:pixelated;object-fit:contain}}aside{{min-width:0;border-left:1px solid var(--line);padding-left:14px}}h2{{font-size:13px;margin:0 0 10px}}dl{{display:grid;grid-template-columns:1fr auto;gap:6px 10px;margin:0 0 12px}}dt{{color:var(--muted)}}dd{{margin:0;text-align:right;max-width:180px;overflow-wrap:anywhere}}a{{color:var(--accent)}}.note{{color:var(--muted);border-top:1px solid var(--line);padding-top:10px;overflow-wrap:anywhere}}@media(max-width:760px){{h1{{width:100%}}main{{grid-template-columns:1fr}}.stage{{width:100%}}aside{{border-left:0;border-top:1px solid var(--line);padding:12px 0 0}}dl{{display:block}}dt{{margin-top:8px}}dd{{text-align:left;max-width:100%;word-break:break-all}}}}
