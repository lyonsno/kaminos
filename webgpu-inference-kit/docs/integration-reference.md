# Advanced Integration Reference

This is the detailed reference for the package's current low-level runtime, resource, cooperative-execution, scheduling, composition, and receipt APIs.

Start with the [package README](../README.md) for product orientation. Read the [Model Port design contract](model-port.md) for the first-class model lifecycle being built over these primitives.
