...
assert.match(routeSource, /addKernel\(k\('Ref2'\), SAM_PACKED_LINEAR_WGSL/, 'reference-point output projection preserves negative coordinates without applying ReLU');
