...
function writeReport(extra = {}) {
  ...
  const value = {
    ...
    parityPassed: lastState?.evidence?.parityPassed ?? null,
    parityState: lastState?.evidence?.parityState ?? null,
    parityGatePassed: lastState?.evidence?.parityGatePassed ?? false,
