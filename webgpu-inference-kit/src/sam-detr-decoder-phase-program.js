...
export async function runSam3DetrDecoderPhaseProgramRoute(input = {}) {
  ...
  return withSamPhaseCleanup(runtime, async () => {
    ...
    for (let layerIndex = 0; layerIndex < shape.layerCount; layerIndex += 1) {
      ...
      addKernel(k('Ref1'), SAM_VECTOR_LINEAR_RELU_WGSL, [bindTensor('tensor:sine'), bindTensor('tensor:refPointHeadLayer1Weight'), bindTensor('tensor:refPointHeadLayer1Bias'), bindTensor('tensor:refPointHidden', 'storage'), bindUniform('sineLinearDims')]);
      addKernel(k('Ref2'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:refPointHidden'), bindTensor('tensor:refPointHeadLayer2Weight'), bindTensor('tensor:refPointHeadLayer2Bias'), bindTensor('tensor:queryPos', 'storage'), bindUniform('queryLinearDims')]);
      ...
      addKernel(k('SelfQ'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:hiddenPlusPos'), bindTensor(`tensor:${layerTensorKeys.selfQWeight}`), bindTensor(`tensor:${layerTensorKeys.selfQBias}`), bindTensor('tensor:q', 'storage'), bindUniform('hiddenLinearDims')]);
      addKernel(k('SelfK'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:hiddenPlusPos'), bindTensor(`tensor:${layerTensorKeys.selfKWeight}`), bindTensor(`tensor:${layerTensorKeys.selfKBias}`), bindTensor('tensor:kHidden', 'storage'), bindUniform('hiddenLinearDims')]);
      addKernel(k('SelfV'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:hidden'), bindTensor(`tensor:${layerTensorKeys.selfVWeight}`), bindTensor(`tensor:${layerTensorKeys.selfVBias}`), bindTensor('tensor:vHidden', 'storage'), bindUniform('hiddenLinearDims')]);
      ...
      addKernel(k('SelfOut'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:attention'), bindTensor(`tensor:${layerTensorKeys.selfOWeight}`), bindTensor(`tensor:${layerTensorKeys.selfOBias}`), bindTensor('tensor:projected', 'storage'), bindUniform('hiddenLinearDims')]);
      ...
      addKernel(k('TextQ'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:hiddenPlusPos'), bindTensor(`tensor:${layerTensorKeys.textQWeight}`), bindTensor(`tensor:${layerTensorKeys.textQBias}`), bindTensor('tensor:q', 'storage'), bindUniform('hiddenLinearDims')]);
      addKernel(k('TextK'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:promptFeatures'), bindTensor(`tensor:${layerTensorKeys.textKWeight}`), bindTensor(`tensor:${layerTensorKeys.textKBias}`), bindTensor('tensor:kPrompt', 'storage'), bindUniform('promptLinearDims')]);
      addKernel(k('TextV'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:promptFeatures'), bindTensor(`tensor:${layerTensorKeys.textVWeight}`), bindTensor(`tensor:${layerTensorKeys.textVBias}`), bindTensor('tensor:vPrompt', 'storage'), bindUniform('promptLinearDims')]);
      ...
      addKernel(k('TextOut'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:attention'), bindTensor(`tensor:${layerTensorKeys.textOWeight}`), bindTensor(`tensor:${layerTensorKeys.textOBias}`), bindTensor('tensor:projected', 'storage'), bindUniform('hiddenLinearDims')]);
      ...
      addKernel(k('VisionQ'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:hiddenPlusPos'), bindTensor(`tensor:${layerTensorKeys.visionQWeight}`), bindTensor(`tensor:${layerTensorKeys.visionQBias}`), bindTensor('tensor:q', 'storage'), bindUniform('hiddenLinearDims')]);
      ...
      addKernel(k('VisionK'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:kVision'), bindTensor(`tensor:${layerTensorKeys.visionKWeight}`), bindTensor(`tensor:${layerTensorKeys.visionKBias}`), bindTensor('tensor:kVisionProjected', 'storage'), bindUniform('visionLinearDims')]);
      addKernel(k('VisionV'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:visionFeatures'), bindTensor(`tensor:${layerTensorKeys.visionVWeight}`), bindTensor(`tensor:${layerTensorKeys.visionVBias}`), bindTensor('tensor:vVision', 'storage'), bindUniform('visionLinearDims')]);
      ...
      addKernel(k('VisionOut'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:attention'), bindTensor(`tensor:${layerTensorKeys.visionOWeight}`), bindTensor(`tensor:${layerTensorKeys.visionOBias}`), bindTensor('tensor:projected', 'storage'), bindUniform('hiddenLinearDims')]);
      ...
      addKernel(k('Mlp1'), SAM_VECTOR_LINEAR_RELU_WGSL, [bindTensor('tensor:hidden'), bindTensor(`tensor:${layerTensorKeys.fc1Weight}`), bindTensor(`tensor:${layerTensorKeys.fc1Bias}`), bindTensor('tensor:mlpHidden', 'storage'), bindUniform('fc1Dims')]);
      addKernel(k('Mlp2'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:mlpHidden'), bindTensor(`tensor:${layerTensorKeys.fc2Weight}`), bindTensor(`tensor:${layerTensorKeys.fc2Bias}`), bindTensor('tensor:projected', 'storage'), bindUniform('fc2Dims')]);
      ...
      addKernel(k('BoxHead1'), SAM_VECTOR_LINEAR_RELU_WGSL, [bindTensor('tensor:lastHs'), bindTensor('tensor:boxHeadLayer1Weight'), bindTensor('tensor:boxHeadLayer1Bias'), bindTensor('tensor:boxHidden1', 'storage'), bindUniform('queryLinearDims')]);
      addKernel(k('BoxHead2'), SAM_VECTOR_LINEAR_RELU_WGSL, [bindTensor('tensor:boxHidden1'), bindTensor('tensor:boxHeadLayer2Weight'), bindTensor('tensor:boxHeadLayer2Bias'), bindTensor('tensor:boxHidden2', 'storage'), bindUniform('queryLinearDims')]);
      addKernel(k('BoxHead3'), SAM_VECTOR_LINEAR_WGSL, [bindTensor('tensor:boxHidden2'), bindTensor('tensor:boxHeadLayer3Weight'), bindTensor('tensor:boxHeadLayer3Bias'), bindTensor('tensor:boxDelta', 'storage'), bindUniform('boxDeltaDims')]);
      ...
      phases.push(
        ...
        { name: `detr-decoder-ref-point-head-1-${layerIndex}`, kernel: k('Ref1'), dispatch: linearWorkgroups(queryTokens, shape.channels * 2, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-ref-point-head-${layerIndex}`, kernel: k('Ref2'), dispatch: linearWorkgroups(queryTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-self-q-${layerIndex}`, kernel: k('SelfQ'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-self-k-${layerIndex}`, kernel: k('SelfK'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-self-v-${layerIndex}`, kernel: k('SelfV'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-self-output-${layerIndex}`, kernel: k('SelfOut'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-text-q-${layerIndex}`, kernel: k('TextQ'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-text-k-${layerIndex}`, kernel: k('TextK'), dispatch: linearWorkgroups(promptTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-text-v-${layerIndex}`, kernel: k('TextV'), dispatch: linearWorkgroups(promptTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-text-output-${layerIndex}`, kernel: k('TextOut'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-vision-q-${layerIndex}`, kernel: k('VisionQ'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-vision-k-${layerIndex}`, kernel: k('VisionK'), dispatch: linearWorkgroups(spatialTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-vision-v-${layerIndex}`, kernel: k('VisionV'), dispatch: linearWorkgroups(spatialTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-vision-output-${layerIndex}`, kernel: k('VisionOut'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-mlp-fc1-${layerIndex}`, kernel: k('Mlp1'), dispatch: linearWorkgroups(hiddenTokens, shape.channels, shape.mlpHidden, input.device), yieldAfter: true },
        { name: `detr-decoder-mlp-fc2-${layerIndex}`, kernel: k('Mlp2'), dispatch: linearWorkgroups(hiddenTokens, shape.mlpHidden, shape.channels, input.device), yieldAfter: true },
        ...
        { name: `detr-decoder-box-head-1-${layerIndex}`, kernel: k('BoxHead1'), dispatch: linearWorkgroups(queryTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-box-head-2-${layerIndex}`, kernel: k('BoxHead2'), dispatch: linearWorkgroups(queryTokens, shape.channels, shape.channels, input.device), yieldAfter: true },
        { name: `detr-decoder-box-head-3-${layerIndex}`, kernel: k('BoxHead3'), dispatch: linearWorkgroups(queryTokens, shape.channels, 4, input.device), yieldAfter: true },
