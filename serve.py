...
def submit_browser_webgpu_greenroom_preview(payload):
    ...
    try:
        ...
        params = {
            ...
            "module_base_url": str(payload.get("moduleBaseUrl") or "").strip(),
            "kaminos_root": str(ROOT),
...
def _browser_webgpu_route_row_from_result(path, result):
    ...
    route_job = {
        ...
        "metadata": {
            ...
            "sourceSelectionMode": route_config.get("sourceSelectionMode"),
            "sourceImageSyntheticFallback": route_config.get("sourceImageSyntheticFallback"),
            "sourceImageLoadFailures": route_config.get("sourceImageLoadFailures") if isinstance(route_config.get("sourceImageLoadFailures"), list) else [],
