...
KAMINOS_SMOKE_ORACLE_DIR = Path(os.environ.get(
    "KAMINOS_SMOKE_ORACLE_DIR",
    str(ROOT / "artifacts" / "smoke-gaussian-oracle-ceiling-0715"),
)).expanduser()
...
BROWSE_ROOTS = {
    ...
    "smoke-oracle": KAMINOS_SMOKE_ORACLE_DIR,
